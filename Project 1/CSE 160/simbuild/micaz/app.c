...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2b9487321020, const void *arg_0x2b9487321320);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x2b94873b45e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2b94876063a0), 
int (*key_eq_fn)(void *arg_0x2b9487606b70, void *arg_0x2b9487606e30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2b9487827c00, int arg_0x2b9487827e80);
static double RandomUniform(void );
...
int Node__neighbors[1000][10];
int Node__neighborCount[1000];
int Node__recievedCounter[1000];
...
static inline bool Node__checkPackages(uint16_t src, uint16_t seq);
...
#line 154
  ...
  Node__recievedSrc[sim_node()][Node__recievedCounter[sim_node()]] = src;
  Node__recievedSeq[sim_node()][Node__recievedCounter[sim_node()]] = seq;

  if (Node__recievedCounter[sim_node()] != 99) {
    Node__recievedCounter[sim_node()] = Node__recievedCounter[sim_node()] + 1;
    }
  else {
#line 168
    Node__recievedCounter[sim_node()] = 0;
    }
  return FALSE;
}
...
#line 64
      ...
      if (__nesc_ntoh_uint16(myMsg->dest.nxdata) != 0) 
        {
          sim_log_debug(112U, FLOODING_CHANNEL, "Package Sent From: %d\n", __nesc_ntoh_uint16(myMsg->src.nxdata));
          sim_log_debug(113U, FLOODING_CHANNEL, "Package Sequence Number: %d\n", __nesc_ntoh_uint16(myMsg->seq.nxdata));
          sim_log_debug(114U, FLOODING_CHANNEL, "Package TTL: %d\n", __nesc_ntoh_uint8(myMsg->TTL.nxdata));

          if (__nesc_ntoh_uint16(myMsg->dest.nxdata) == TOS_NODE_ID) {
              sim_log_debug(115U, FLOODING_CHANNEL, "Package has reached destination\n");
              return msg;
            }
          else {
#line 76
            if (__nesc_ntoh_uint8(myMsg->TTL.nxdata) > 0 && !Node__checkPackages(__nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->seq.nxdata)) && __nesc_ntoh_uint16(myMsg->src.nxdata) != TOS_NODE_ID) {
                ...
                sim_log_debug(116U, FLOODING_CHANNEL, "Flooding...\n");
              ...
              {
                sim_log_debug(117U, FLOODING_CHANNEL, "TTL termination/Duplicate Package\n");
                return msg;
              }
            }
        }
      sim_log_debug(118U, NEIGHBOR_CHANNEL, "Neighbor is: %d\n", __nesc_ntoh_uint16(myMsg->src.nxdata));
      Node__addNeighbor(__nesc_ntoh_uint16(myMsg->src.nxdata));
      sim_log_debug(119U, NEIGHBOR_CHANNEL, "Number of Neighbors: %d\n", Node__neighborCount[sim_node()]);
      return msg;
    }
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x2b9487b3ce30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b9487b3ce30) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x2b9487b3ce30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x2b9487b3ba50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x2b9487b3ba50, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x2b9487afec70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x2b9487afec70, msg, error);
#line 110
}
#line 110
...
#line 88
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x2b948817db60, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x2b948817db60, addr, msg, len);
#line 80
...
#line 133
        {
          ...
          sim_log_debug(149U, GENERAL_CHANNEL, "The radio is busy, or something\n");
          return FAIL;
        }
    }
  else 
#line 138
    {
      sim_log_debug(150U, GENERAL_CHANNEL, "The radio is busy");
      return EBUSY;
    }


  sim_log_debug(151U, GENERAL_CHANNEL, "FAILED!?");
  return FAIL;
}
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x2b948817e940, message_t * msg, error_t error){
#line 100
  switch (arg_0x2b948817e940) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x2b948817e940, msg, error);
#line 100
      break;
#line 100
    }
  ...
  for (i = 0; i < 10; i++) 
    {
      if (Node__neighbors[sim_node()][i] > 0) 
        {
          printf("%d ", Node__neighbors[sim_node()][i]);
        }
    }
...
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x2b9487941320){
#line 75
  switch (arg_0x2b9487941320) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x2b9487941320);
#line 75
      break;
#line 75
    }
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x2b9488079950){
#line 83
  switch (arg_0x2b9488079950) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x2b9488079950);
#line 83
      break;
#line 83
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "Node__recievedCounter"))
  {
    *addr = (uintptr_t)&Node__recievedCounter[__nesc_mote];
    *size = sizeof(Node__recievedCounter[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  Node__neighborCount[__nesc_mote] = 0;
  Node__recievedCounter[__nesc_mote] = 0;
